...
f2(5, 1) = -sum(sum(histX.*log2(histX+ 0.000001)))/round(xlim); %entropy
...
f2(5, 2) = -sum(sum(histY.*log2(histY+ 0.000001)))/round(ylim); %entropy
...
f2(5, 3) = -sum(sum(histZ.*log2(histZ+ 0.000001)))/round(zlim); %entropy
